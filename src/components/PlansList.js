    ...
    <View>
      {plans.map((plan, index) => {
        ...
        const planData = {
          ...
          sessionalOffIcon: plan.sessional_off_icon || null,
          sessionalOffProduct: plan.sessional_off_product || null,
          sessionalOffProductIcon: plan.sessional_off_product_icon || null,
          promoOffer: {
